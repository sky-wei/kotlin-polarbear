 ...
 */
fun IAppContext.getDataBaseManager(): IDataBaseManager {
    return getComponent(IDataBaseManager::class.java)
}

fun IAppContext.getAppRepository(): IAppRepository {
    return getComponent(IAppRepository::class.java)
}